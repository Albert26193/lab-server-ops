...
- [[#1.简介|1.简介]]
	- [[#1.简介#1.1 概览|1.1 概览]]
	- [[#1.简介#1.2 分支说明|1.2 分支说明]]
	- [[#1.简介#1.3 功能预览|1.3 功能预览]]
		- [[#1.3 功能预览#1.3.1 分发用户功能|1.3.1 分发用户功能]]
		- [[#1.3 功能预览#1.3.2 用户广播功能|1.3.2 用户广播功能]]
		- [[#1.3 功能预览#1.3.3 用户基本配置|1.3.3 用户基本配置]]
		- [[#1.3 功能预览#1.3.4 便捷性增强功能|1.3.4 便捷性增强功能]]
- [[#2. 安装|2. 安装]]
	- [[#2. 安装#2.1 确认分支|2.1 确认分支]]
	- [[#2. 安装#2.2 安装过程|2.2 安装过程]]
		- [[#2.2 安装过程#2.2.1 `linux` 分支|2.2.1 `linux` 分支]]
		- [[#2.2 安装过程#2.2.2 `linux-minimum` 分支|2.2.2 `linux-minimum` 分支]]
		- [[#2.2 安装过程#2.2.3`mac-personal` 分支|2.2.3`mac-personal` 分支]]
- [[#3. 使用|3. 使用]]
	- [[#3. 使用#3.1 对于 `Linux` 管理员|3.1 对于 `Linux` 管理员]]
	- [[#3. 使用#3.2 对于普通用户|3.2 对于普通用户]]
- [[#4. 配置|4. 配置]]
- [[#5. 开发计划|5. 开发计划]]
